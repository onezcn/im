...
/* ========================================================================
 * $Id: lessc.inc.php 94964 2017-06-26 20:11:33Z onez $
 * 
 * Email: www@onez.cn
 * QQ: 6200103
...
class lessc {
	...
	protected function tryImport($importPath, $parentBlock, $out) {
		...
		$root = $parser->parse(onez()->post($realPath));
		...
		if($fullpath && ($fsize = filesize($fullpath)) !== false) {
			...
			if($fsize/1024 < 32) {
				...
				if(!is_null($mime)) // fallback if the mime type is still unknown
					$url = sprintf('data:%s;base64,%s', $mime, base64_encode(onez()->post($fullpath)));
			}
		}
	...
	public function compileFile($fname, $outFname = null) {
		...
		$out = $this->compile(onez()->post($fname), $fname);
